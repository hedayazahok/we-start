@extends('master')
@section('title', ($bill!=null)? "Invoice-$bill->id":"create Invoice")
...
@section('styles')
    ...
    <div class="addItem" id="addItem">
        ...
        <a type="button" class="btn btn-success" href="" id="saveInvoice" data-whatever="@mdo">Save Invoice</a>
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e){
           ...
           $.ajax({
              ...
              $('#invoice_no').text(response.bill.invoice_no)
...
var total=0;
        $("#addBtn").click(function(e){
         ...
         $('#itemsTable').append("<tr id='item_"+data.item.id+"'><td>" + data.item.item_name + "</td><td>" + data.item.quantity + "</td><td>" + data.item.cost + "</td></tr>");
