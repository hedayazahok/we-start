...
Make a regular profit by converting your high-quality business into products and displaying them for sale in Baikalia, the Arab Digital Products Store
    ...
    <div class="card h-100">
        <div class="card-body">
            <form action="{{route('freelancer.portfolios.update',$portfolio->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <h6 class="mb-2 text-primary">Edit Portfolio</h6>
                </div>
                    @csrf
                <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                        <label for="fullName">Portfolio title</label>
                        <input type="text"  name="title" value="{{$portfolio->title}}" class="form-control @error('title') is-invalid @enderror" id="fullName" placeholder="Enter full name"  >
                    </div>
                    @error('title')
                ...
                <div class="col-xl-12 col-lg-12 col-lg-12 col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control" >
                            ...
                            <option value="{{$category->id}}" @if($portfolio->category_id !=null) {{$portfolio->category_id == $category->id ? 'selected' : ''}} @endif > {{$category->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control"
                            id="inputImage" >
                        <img width="80" class="img-thumbnail" src="{{asset($portfolio->image->path)}}">
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-lg-12 col-lg-12 col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <textarea  name="desc" class="form-control  @error('desc') is-invalid @enderror" rows="10"  >{{$portfolio->desc}}</textarea>
                ...
                <div class="col-xl-12 col-lg-12 col-lg-12 col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="url"  name="urls" class="form-control @error('urls') is-invalid @enderror" id="fullName" placeholder="Enter full name" value="{{$portfolio->urls}}" >
                    </div>
                    @error('title')
                    <div class="danger">{{ $message }}</div>
                     @enderror
                ...
                <div class="col-xl-12 col-lg-12 col-lg-12 col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$portfolio->skills}}"  class="form-control" data-role="tagsinput" name="skills" >
                ...
                <div class="col-xl-12 col-lg-12 col-lg-12 col-lg-12 col-12">
                    <div class="form-group">
                        ...
                        <input type="date"  value={{$portfolio->exec_date}} name="exec_date" class="form-control @error('exec_date') is-invalid @enderror" id="exec_date" placeholder="Enter full name" required >
                    </div>
                    @error('exec_date')
                    <div class="danger">{{ $message }}</div>
                     @enderror
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-2">
                        <label for="exec_date">Previous uploaded files</label>

                        <ul style="list-style: none;display:flex;justify-content:space-between">
                        @foreach ($portfolio->files as $file )
                        <li style="display: block" id="image-{{$file->id}}">  <img width="80"  src="{{asset($file->path)}}">  <button class="btn btn-danger" onclick="removeImage({{$file->id}},event)" ><i class="fa fa-trash"></i></button></li>
...
<script>
    function removeImage(id,e){
        e.preventDefault();
        axios.post('/freelancer/portfolios/fileUploadRemoved/'+id)
  .then(function (response) {
      let imag= document.getElementById('image-'+id);
