...
<div class="container">
    ...
    <div class="card h-100">
        <div class="card-body">
            <form method="post" action="{{route('client.profile.setting',$user->id)}}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="account-settings">
                <div class="user-profile">
                    <div class="user-avatar">
                        ...
                        <input type="image" src="{{asset(Auth::user()->image->path)}}" class="rounded-circle"   width="150" height="150" >
                        @else
